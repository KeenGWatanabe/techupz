...
export const categories = [
  ...
  { label: 'Skiing', icon: FaSkiing, description: 'This property has skiing activiities' },
  ...
  { label: 'Artic', icon: BsSnow, description: 'This property has artic activities.' },
  { label: 'Cave', icon: GiCaveEntrance, description: 'This property is in a cave!' },
  { label: 'Desert', icon: GiCactus, description: 'This property is in a desert!' },
